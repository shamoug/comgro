...
CG.CONTENT.es={
 ...
 "ui.dilemma": "Dilema",
 "log.reroll": "Tentaste tu suerte: gastaste 1 Datos para volver a tirar.",
 "ui.synergyReady": "sinergia lista para tu siguiente acción coincidente.",
 "ui.directEffort": "Dirige este esfuerzo conjunto hacia...",
 "ui.tip": "Consejo",
 "dice.roll": "Tirada de entrega",
 "dice.crit": "¡Entrega crítica!",
 "dice.solid": "Entrega sólida",
 "dice.partial": "Entrega parcial",
 "dice.setback": "Revés",
 "dice.pressLuck": "Tienta tu suerte: vuelve a tirar por 1 Datos",
 "dice.keep": "Conservar resultado",
 "dice.bonus": "bonificación de probabilidad",
 "dice.fortuneTitle": "Fortuna del mes",
 "fortune.1.name": "Viento en contra",
 "fortune.1.desc": "Mes difícil: los choques golpean un poco más fuerte.",
 "fortune.2.name": "Aguas tranquilas",
 "fortune.2.desc": "Un mes estable. Aprovéchalo.",
 "fortune.3.name": "Punto brillante",
 "fortune.3.desc": "Las buenas noticias viajan: +1 Datos.",
 "fortune.4.name": "Viento a favor",
 "fortune.4.desc": "El viento está contigo: +1 a cada tirada de entrega.",
 "fortune.5.name": "Golpe de suerte",
 "fortune.5.desc": "Un impulso inesperado: +2 Financiación.",
 "fortune.6.name": "Impulso",
 "fortune.6.desc": "En racha: tu primera acción es un crítico garantizado.",
 "praise.0": "Brillante. Eso salió perfecto.",
 "praise.1": "Todo el equipo está imparable hoy.",
 "praise.2": "Coordinación de manual. Sahelia lo notó.",
 "praise.3": "Así es como se entrega.",
 "praise.4": "Sobresaliente. El terreno lo recordará.",
 "tease.0": "Un mal día. Hasta los mejores los tienen.",
 "tease.1": "La realidad se resistió esta vez.",
 "tease.2": "No fue tu mejor momento, pero mantuviste la línea.",
 "tease.3": "El terreno tenía otros planes. Sacúdetelo.",
 "tease.4": "Entrega accidentada. Mañana es otro mes.",
 "tip.0": "Consejo: invierte en Datos pronto. Compra nuevas tiradas y mejora tus probabilidades de entrega.",
 "tip.1": "Consejo: eleva la Prospectiva por encima de la mitad y cada acción tendrá un poco más de suerte.",
 "tip.2": "Consejo: juega una Alianza justo antes de una acción coincidente para potenciarla.",
 "tip.3": "Consejo: usa acciones de generación de Confianza cuando se avecinen crisis. La Confianza es tu salvavidas.",
 "tip.4": "Consejo: equilibra los cinco pilares. Acumular uno rara vez es la ruta más rápida al oro.",
 "tip.5": "Consejo: un Crítico (sacar un 6) da un 145% de efecto y un punto de Impacto adicional.",
 "tip.6": "Consejo: convoca a los socios para acumular Coordinación, luego lanza un Programa conjunto.",
 "tip.7": "Consejo: cuando un dado caiga en 1, vuelve a tirar con Datos si la acción realmente importa.",
 "tip.8": "Consejo: usa la habilidad de tu rol cada mes. Es gratis y a menudo decisiva.",
 "tip.9": "Consejo: resuelve las crisis rápido. Cada crisis activa drena Confianza cada mes."
};
})();
