...
(function () {
  ...
  CG.ROLES = [
    ...
    { icon: "🤝", name: "Deputy Humanitarian Coordinator", tag: "Carries the operational load and the sub-national coordination." },
    { icon: "🏢", name: "Head of OCHA Office", tag: "Runs coordination, advocacy and the financing in one country." },
    { icon: "🔁", name: "Inter-Cluster Coordinator", tag: "Keeps every sector pulling in the same direction." },
    { icon: "📍", name: "Area Coordinator", tag: "Owns the response for one slice of the map." },
    { icon: "🛰️", name: "Subnational Coordinator", tag: "Runs the hub far from the capital, closest to the field." },
    // access, civil-military, security
    { icon: "🚪", name: "Access Negotiator", tag: "Talks every checkpoint open, with everyone, every day." },
    { icon: "🪖", name: "Civil-Military Coordination Officer", tag: "Guards the line between the soldiers and the aid." },
    { icon: "🛰️", name: "Security Officer (UNDSS)", tag: "Reads the threat so the team can keep working safely." },
    { icon: "📞", name: "Liaison Officer", tag: "Keeps the doors to government and partners open." },
    // information, data, assessment
    { icon: "📝", name: "Reporting Officer", tag: "Turns a chaotic week into a situation report that lands." },
    { icon: "🛰️", name: "GIS Officer", tag: "Draws the maps the whole operation steers by." },
    { icon: "🧮", name: "Data Scientist", tag: "Finds the signal in the noise, and forecasts the next one." },
    { icon: "📐", name: "Monitoring and Evaluation Officer", tag: "Checks whether the help actually helped." },
    { icon: "🔍", name: "Third-Party Monitor", tag: "Verifies the aid landed where no staff can safely go." },
    // sector and technical
    { icon: "🩹", name: "Health Cluster Coordinator", tag: "Lines up every clinic and partner so no one is missed." },
    { icon: "🛖", name: "Shelter and NFI Specialist", tag: "Gets a roof and the basics over families fast." },
    { icon: "🏕️", name: "Camp Management Officer", tag: "Holds standards, services and dignity inside the site." },
    { icon: "🌾", name: "Food Security Officer", tag: "Reads the hunger map before it turns into a famine." },
    { icon: "💣", name: "Mine Action Officer", tag: "Clears the ground so returnees can walk it safely." },
    { icon: "📚", name: "Education in Emergencies Specialist", tag: "Keeps children learning when everything else stops." },
    { icon: "🧠", name: "MHPSS Officer", tag: "Tends the wounds no scan will ever show." },
    // recovery, resilience, risk
    { icon: "🌅", name: "Early Recovery Adviser", tag: "Restarts livelihoods before the cameras leave." },
    { icon: "🕊️", name: "Durable Solutions Adviser", tag: "Works to end displacement, not just manage it." },
    { icon: "🌐", name: "Resilience Adviser", tag: "Builds the strength to take the next shock standing." },
    { icon: "⚠️", name: "Disaster Risk Reduction Specialist", tag: "Stops the hazard from ever becoming a disaster." },
    { icon: "🛡️", name: "Anticipatory Action Adviser", tag: "Releases the plan before the forecast becomes a flood." },
    // accountability, community, inclusion
    { icon: "🚨", name: "PSEA Coordinator", tag: "Makes it safe to report, and acts when someone does." },
    { icon: "👂", name: "AAP Adviser", tag: "Puts affected people at the centre of the decision." },
    { icon: "📻", name: "Risk Communication Officer", tag: "Gets the trusted message out before the rumour does." },
    { icon: "♿", name: "Disability Inclusion Adviser", tag: "Makes sure no one is left at the edge of the queue." },
    { icon: "⚖️", name: "Gender Adviser", tag: "Reads the different risks women, men, girls and boys carry." },
    // finance, partnerships
    { icon: "🏦", name: "Pooled Fund Manager", tag: "Steers flexible cash to the gap that matters most." },
    { icon: "🤲", name: "Partnerships Officer", tag: "Builds the alliances that carry the whole response." },
    { icon: "📨", name: "Donor Relations Officer", tag: "Keeps the money honest and the reporting clean." },
    // national, local, frontline
    { icon: "🏥", name: "Community Health Worker", tag: "The first and nearest line of care, on foot." },
    { icon: "📋", name: "Registration Officer", tag: "Gives people the paper that unlocks their rights." },
    { icon: "🗃️", name: "Protection Case Worker", tag: "Walks one person from danger to safety, file by file." },
    { icon: "🚐", name: "Logistics Officer", tag: "Moves the fleet, the fuel and the freight on time." },
    { icon: "🌍", name: "Refugee Coordinator", tag: "Leads the refugee response under UNHCR's model." },
  ];
